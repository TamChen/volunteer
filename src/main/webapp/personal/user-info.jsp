...
<html>
  ...
  <body>
   <jsp:include  page="../head.jsp"/>
            ...
            <div class="row" >
                ...
                <div class="col-md-9">
                        ...
                        <div class="col-md-9" style="margin-top:40px;">
                            <span class="sub-title"><span class="user_name"></span>的个人信息</span>
                        </div>
                            <div class="col-md-12">
                                <table style="float: left;font-family:微软雅黑;margin-left:4%;width: 40%;min-height: 150px;"  class="table table-condensed">
	                                <tr><td>学号</td><td><span id="userno_info"></span></td></tr>
	                                <tr><td>学院</td><td><span id="college_info"></span></td></tr>
	                                <tr><td>专业</td><td><span id="major_info"></span></td></tr>
	                                <tr><td>性别</td><td><span id="sex_info"></span></td></tr>
                                </table>
                                
                                <table style="float: left;font-family:微软雅黑;margin-left:4%;width: 40%;min-height: 150px;"  class="table table-condensed">
	                                <tr><td>义工时长</td><td><span class="time_info"></span></td></tr>
	                                <tr><td>生日</td><td><span id="userBir_info"></span></td></tr>
	                                <tr><td>居住地</td><td><span id="userAddress_info"></span></td></tr>
	                                <tr><td>邮箱</td><td><span id="userMail_info"></span></td></tr>
                                </table>
                            </div>  
                        <div class="col-md-9" style="margin-top:40px;">
                            ...
                            <div class="col-md-12">
                            <pre id="short_userinfo"></pre>
                        	 </div>
                         <div class="col-md-9" style="margin-top:40px;font-family:'微软雅黑'">
                            <span class="sub-title" ><span class="user_name"></span>的时长</span>(<span  class="time_info"></span>)
                        </div> 
                        <div class="col-md-12">
                           <table class="table table-striped table-bordered table-hover datatable">
                                <thead>
									<tr>
							             ...
							             <th class="table-title">发布方</th>
							             <th class="table-title">活动地点</th>
							             <th class="table-title">活动时间</th>
							             <th class="table-title">获得时长</th><!-- 感兴趣、报名、参加、 -->
									</tr>
								</thead>
	...
	<script type="text/javascript" src="static/js/personal/user-info.js"></script>
