...
<html>
  ...
  <body>
   <jsp:include  page="../head.jsp"/>
                ...
                <div class="col-md-9">
                        ...
                        <div class="col-md-12" id="album_list">
                        	<div class="upload_muti_pic">
                        		<div class="muti_input">
	                         	...
	                         	<div class="upload_tip">提示：按着 “ctrl” 键可以一次选择多张照片,单张图片限制为5M,在不稳定的情况下请单张上传。。</div>
	                         </div><%--
	                         <div style="width:183px;height:44px;background-color:#F54D80;text-align:center;">
	                         <div style="font-size:15px;width:100px;height:20px;margin-left:45px;padding-top:10px;color:white;font-family:'微软雅黑'">选择图片上传
	                         </div>
	                         </div>
                        --%></div>
                        ...
                        <div class="after_upload_tip">提示：按着 “ctrl” 键可以一次选择多张照片,单张图片限制为5M,在不稳定的情况下请单张上传。</div>
                        	 <div class="col-md-12" id="upload_pic_show">
	                        	<div class="show_upload_pic"></div>
	                        </div>
                       <div class="col-md-9" id="attend_title" style="margin-top:40px;">
                            <a  class="sub-title" href="javascript:void(0)">新增相册</a>
                       </div>
                       <div class="col-md-12">
    ...
    <script type="text/javascript" src="static/js/personal/user-addAlbum.js"></script>
