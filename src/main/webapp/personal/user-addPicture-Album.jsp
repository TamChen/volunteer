...
<html>
  ...
  <body>
   <jsp:include  page="../head.jsp"/>
            ...
            <div class="row" >
                ...
                <div class="col-md-9">
                        ...
                        <div class="col-md-11" id="attend_title" style="margin-top:40px;">
                            <a  class="sub-title" href="javascript:void(0)" onclick="turnBack()"><span class="user_name"></span>的相册><span class="alubmName"></span><span >>添加照片 </span></a>
    ...
    <script type="text/javascript" src="static/js/personal/user-edit-add.js"></script>
