...
<html>
            ...
            <div class="row" >
                ...
                <div class="col-md-9">
                        ...
                        <div class="col-md-9" style="margin-top:40px;">
                            <span class="sub-title" id="record-title"></span>
                        </div>
                        <div class="col-md-8">
                        	<span class="record-time">2015-03-15 20:33:29</span>
                        	<span class="delete_record"></span>
                        </div> 
                        <div style="with:100%;height:1px;clear:both;"></div>
                        <div class="content_record" style="">
                                <pre class="all-record-detail"></pre>
                        </div>    
  ...
  <script type="text/javascript" src="static/js/personal/record-detail.js"></script>
