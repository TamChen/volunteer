...
<html>
  ...
  <body>
   <jsp:include  page="../head.jsp"/>
            ...
            <div class="row" >
                ...
                <div class="col-md-9">
                        ...
                        <div class="col-md-11" id="attend_title" style="margin-top:40px;">
                            <a  class="sub-title" href="javascript:void(0)"><span class="user_name"></span>的相册</a>
                        ...
                        <div class="col-md-12" id="album_list_index"><%--
                            <div class="each_album"><!---->
	                            <a class="img_album" href="##">
	                              <img class="album" src="image/activity/170X170.jpg"><!--名字、简介、创建时间-->
	                            </a>
	                            <div class="albumname"><a href="##">第一个相册</a></div>
	                            <div class="albumIntro">9张照片  2015-04-11更新</div>
                            </div>
    ...
    <script type="text/javascript" src="static/js/personal/user-album.js"></script>
