...
<html>
  ...
  <body>
   <jsp:include  page="../head.jsp"/>
            ...
            <div class="row" >
                <div class="col-md-3">
                    ...
                    <div id="friend">                  
                        ...
                        <span class="cancel_attention"><a href='javascript:void(0)' onclick='cancel_Attendtion()'>取消关注</a></span>
                ...
                <div class="col-md-9">
                        <div class="col-md-10" >
                         ...
                         <div class="col-md-11">
                            ...
                            <span class="sub-title" id="act_user_title">Penicillus参加过的活动</span>
                        </div>
                        <ul class="col-md-12" id="Activity_list">
	...
	<script type="text/javascript" src="static/js/personal/user-activity.js"></script>
