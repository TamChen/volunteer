            ...
            <div class="row" >
                ...
                <div class="col-md-9">
                        ...
                        <div class="col-md-9" id="attend_title" style="margin-top:40px;">
                            <a  class="sub-title" href="javascript:void(0)" onclick="attend()" id="act_type_attend"></a>
                        </div>
                        <div class="col-md-12" id="attend_content">
                            <ul id="act-attend" class="user-act" style="width:600px;">
                            </ul>
                        </div>
                        
                         <div class="col-md-9" id="interest_title" style="margin-top:40px;">
                            <a  class="sub-title" href="javascript:void(0)" onclick="interest()" id="act_type_interest"></a>
                        </div>
                        <div class="col-md-12" id="interest_content" >
                            <ul id="act-interest" class="user-act" style="width:600px;">
                            </ul>
                        </div>
                        <div class="col-md-9" id="register_title" style="margin-top:40px;">
                            <a  class="sub-title" href="javascript:void(0)" onclick="register()" id="act_type_register"></a>
                        </div>
                        <div class="col-md-12" id="register_content" >
                            <ul id="act-register" class="user-act" style="width:600px;">
                            </ul>
                        </div>
                        <div class="comment">
