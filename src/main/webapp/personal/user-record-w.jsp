...
<html>
  ...
  <body>
   <jsp:include  page="../head.jsp"/>
            ...
            <div class="row" >
                ...
                <div class="col-md-9">
                        ...
                        <div class="col-md-9" style="margin-top:40px;">
                            <span class="sub-title" style="font-size:20px;">新加日记</span>
                        </div>
                        ...
                        <div id="write_diary">
	                        <ul class="col-md-12" id="mail-detail">
	                         ...
	                         <div class="col-md-9" >
	                        <span style="width:100%" class="sub-title">标题</span>
	                        </div>
	                        <form id="reply_form">
	                        	<input id="record_title" type="text" style="width:100%;margin-top:10px; ">
	                        </form>
	                        <div class="col-md-11" >
	                        <span style="width:100%" class="sub-title">内容</span>
	                        <span class="sub-title"><a href="javascript:void(0)" onclick="insert_link()" class="inset_link" style="width:60px;height:20px;float:right;">插入链接</a></span> 
	                        <span class="sub-title"><a href="javascript:void(0)" onclick="insert_photo()" class="inset_photo" style="width:80px;height:20px;float:right;">插入图片></a></span> 
	                        
	                        </div>
	                        <form id="record_form" action="diaryAction!postRecord.action" method="post">
	                        	<textarea id="record_content" name="recordContent" style="width:100%;margin-top:10px; height:400px;"></textarea>
	                        	 <input id="submit_record_edit" name="title" class="submit" onclick="preview_record()" type="button" value="预览">
	                        	<input id="preview_record_edit"  class="submit" onclick="publish_record()" type="button" value="发表">
	                           <input id="cancel_record_edit"  class="submit" onclick="cancel_record()" type="button" value="取消">
	                           
	                        </form>
                        </div>
                        </div>
                        <div class="col-md-11" style="height:auto"><%--
                        <div id="preview_diary">
                        	<div class="col-md-12"></div>
                        	<div class="col-md-9" >
	                        	<span style="width:100%;" id="log_title" class="sub-title"></span>
	                        </div>
	                        <div class="col-md-11">
	                        	<pre id="log_content"></pre>
	                        </div>
	                        <form id="record_form_preview" style="height:50px;backgroud-color:green;margin-top:20px;">
	                        	 <input id="continue_record" style="width:55px;" class="submit" onclick="continue_edit()" type="button" value="继续编辑">
	                        	<input id="publish_record"  class="submit" onclick="publish_record()" type="button" value="发表">
	                        </form>
                        </div>
                        --%></div>
	...
	<script type="text/javascript" src="static/js/personal/record_w.js"></script>
