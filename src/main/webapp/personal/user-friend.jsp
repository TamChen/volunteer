...
<html>
  ...
  <body>
   <jsp:include  page="../head.jsp"/>
            ...
            <div class="row" >
                ...
                <div class="col-md-9">
                        ...
                        <div class="col-md-9" style="margin-top:40px;">
                            <span class="sub-title"><span id=user_attention_titile></span></span>
                        </div>
                        <ul class="col-md-12" id="all_friend"></ul>   
	...
	<script type="text/javascript" src="static/js/personal/user-friend.js"></script>
