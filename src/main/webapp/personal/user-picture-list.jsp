...
<html>
  ...
  <body>
   <jsp:include  page="../head.jsp"/>
            ...
            <div class="row" >
                ...
                <div class="col-md-9">
                        ...
                        <div class="col-md-11" id="attend_title" style="margin-top:40px;">
                            ...
                            <a  class="sub-title" href="javascript:void(0)" onclick="turnBack()"><span class="user_name"></span>的相册><span class="alubmName"></span></a>
                        ...
                        <div class="col-md-12" id="user_pic_list"><%--
                            <div class="user_pic_item"><!--第一个相册，如果点击创建，则把这个隐藏-->
	                            <a class="img_user" href="##">
	                              <img class="user_pic" src="image/activity/test.jpg"><!--名字、简介、创建时间-->
	                            </a>
	                            <div class="pic_intro">9张照片  2015-04-11更新</div>
                            </div>
    ...
    <script type="text/javascript" src="static/js/personal/user-pic-list.js"></script>
