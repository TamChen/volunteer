...
<html>
  ...
  <body>
                ...
                <div class="col-md-9">
                        <div class="col-md-10" >
                         ...
                         <div class="col-md-9" style="margin-top:40px;">
                            <span class="sub-title"><span class="user_name"></span>的日记</span>
                            <span class="w-record"> <a href='javascript:void(0)' onclick='w_record()'>写日记</a></span>
                        </div>
                            <ul class="col-md-12" id="record-list_all">
    ...
    <script type="text/javascript" src="static/js/personal/user-record.js"></script>
