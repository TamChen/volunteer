            ...
            <div class="navigation">
                <div class="navicontainer">
                    ...
                    <ul id="nav-1"> 
                        ...
                        <li><a href="news/new-list.jsp">新闻通知</a></li> 
                    ...
                    <div id="login">
                        ...
                        <div id="login-right">
                        	<a id="name" href="#"><%=session.getAttribute("username")%>|消息</a>
                        	<a href="notice/notice.jsp"><span class="info"><%=session.getAttribute("infonum")%></span></a>
